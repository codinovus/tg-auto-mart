...
@Component({
    ...
    providers: [StoreService, ConfirmationService, MessageService]
})
export class ListStoreComponent implements OnInit, OnDestroy {
    ...
    confirmDelete(event: Event, storeId: string | number) {
    ...
    navigateToCreateStore() {
        this.router.navigate(['/pages/store/create']);
    }
