...
import { CreateDepositRequestDto, DepositRequestResponseDto, GetAllDepositRequestsResponseDto, GetDepositRequestByIdResponseDto, UpdateDepositRequestDto } from '../../pages/deposit/model/deposit-request.dto';
...
export class DepositRequestService {
     ...
     */
    getAllDepositRequests(page: number = 1, limit: number = 10, search?: string): Observable<GetAllDepositRequestsResponseDto> {
