...
import { CreatePaymentDto, GetAllPaymentsResponseDto, PaymentResponseDto, UpdatePaymentDto, GetPaymentByIdResponseDto } from '../../pages/payment/model/payment.dto';
...
export class PaymentService {
     ...
     */
    getAllPayments(page: number = 1, limit: number = 10, search?: string): Observable<GetAllPaymentsResponseDto> {
